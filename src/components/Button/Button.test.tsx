...
describe('Button', () => {
  ...
  it.each`
    ...
    ${ButtonColor.Primary} | ${'background-image'} | ${`linear-gradient( 0deg, ${theme.colors.buttonContainedBg1} 0%, ${theme.colors.buttonContainedBg2} 100% )`}
  ...
  it.each`
    ...
    ${ButtonVariant.Contained} | ${'background-image'} | ${`linear-gradient( 0deg, ${theme.colors.buttonContainedBg1} 0%, ${theme.colors.buttonContainedBg2} 100% )`}
